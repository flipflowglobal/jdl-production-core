...
use super::cfg::CFG;
use super::disasm::Disassembly;
use super::signatures::SignatureReport;
use super::symbolic::{SymExec, Stmt, BlockResult};
use super::types::{StorageVar, CalldataParam, EvmType};
...
fn reconstruct_params(group: &FnGroup) -> Vec<ParamOut> {
    ...
    deduped.iter().enumerate().map(|(i, _p)| {
